 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LEFT                 , KC_A  , KC_S  , KC_D                     , KC_F             , KC_G /*   ,                 , */                          , KC_H      , KC_J                , KC_K                   , KC_L         , KC_SCOLON , ST_MACRO_QUOT ,
  OSM(MOD_LSFT)           , KC_Z  , KC_X  , KC_C                     , KC_V             , KC_B      , LT(_FN, KC_END) , LT(_FN, KC_HOME)            , KC_N      , KC_M                , KC_COMM                , ST_MACRO_DOT , KC_SLSH   , OSM(MOD_RSFT) ,
                       /* ,       ,       , */      LALT_T(KC_MINUS) , LCTL_T(KC_EQUAL) , MO(_SYML) , OSL(_NAV)       , KC_SPC                      , MO(_SYMR) , RCTL_T(KC_LBRACKET) , ALGR_T(KC_RBRACKET) /* ,              , */
),
...
//   )           ,
  ...
  // vim normal
 [_NAV] = LAYOUT(
  TO(_QWERTY) , KC_NO          , KC_NO          , MO(_DBGL)      , KC_NO         , KC_NO         /* ,                        , */       , KC_NO           , KC_NO        , KC_NO     , KC_NO    , KC_NO           , KC_NO          ,
  TO(_QWERTY) , KC_NO          , LCTL(KC_RIGHT) , LCTL(KC_RIGHT) , LCTL(KC_Y)    , KC_NO         /* ,                        , */       , LCTL(KC_INSERT) , LCTL(KC_Z)   , KC_HOME   , KC_END   , LSFT(KC_INSERT) , KC_BSPACE      ,
  KC_NO       , KC_APPLICATION , KC_NO          , KC_DELETE      , KC_NO         , KC_NO    /*      ,                        , */       , KC_LEFT         , KC_DOWN      , KC_UP     , KC_RIGHT , ST_MACRO_31     , KC_NO          ,
  KC_LSHIFT   , KC_NO          , LCTL(KC_X)     , KC_NO          , OSM(MOD_LSFT) , LCTL(KC_LEFT)    , KC_END                 , KC_HOME  , KC_F3           , KC_PGUP      , KC_PGDN   , KC_NO    , LCTL(KC_F)      , LCTL(KC_ENTER) ,
   /*         ,                ,                , */ KC_LALT     , KC_LCTRL      , KC_TRANSPARENT   , KC_F23/*autocomplete*/ , KC_ENTER , KC_NO           , LSFT(KC_TAB) , KC_TAB /* ,          , */
  )           ,
  ...
  /*  ), */
  [_SYML] = LAYOUT(
   TO(_QWERTY)          , KC_NO      , ST_MACRO_LPRN , ST_MACRO_RPRN  , KC_NO       , KC_NO /*        ,                 , */              , KC_NO    , KC_NO               , ST_MACRO_ARROW          , ST_MACRO_EQ_ARROW    , KC_NO   , KC_NO     ,
   MO(_DBGL)            , ST_MACRO_1 , ST_MACRO_2    , ST_MACRO_3     , ST_MACRO_4  , ST_MACRO_5   /* ,                 , */              , KC_6     , KC_7                , KC_8                    , KC_9                 , KC_0    , KC_BSLASH ,
   KC_NO                , ST_MACRO_6 , ST_MACRO_7    , KC_NO          , ST_MACRO_9  , KC_NO        /* ,                 , */              , KC_CIRC  , KC_AMPR             , KC_ASTR                 , KC_LPRN              , KC_RPRN , KC_PIPE   ,
   KC_LSHIFT            , KC_NO      , OSL(_DBGL)    , ST_MACRO_10    , ST_MACRO_11 , ST_MACRO_31     , ST_MACRO_PROJ_S , KC_NO           , TO(_FN)  , KC_NO               , KC_LEFT_CURLY_BRACE     , KC_RIGHT_CURLY_BRACE , KC_NO   , KC_CAPS   ,
                     /* ,            ,               , */     KC_LALT , KC_LCTRL    , KC_TRANSPARENT  , KC_NO           , ST_MACRO_STRUCT , MO(_APP) , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE /* ,                      , */

   ),
  [_SYMR] = LAYOUT(
   TO(_QWERTY)    , KC_NO   , ST_MACRO_LPRN , ST_MACRO_RPRN         , KC_NO             , KC_NO /*       ,            , */              , KC_NO          , KC_NO    , ST_MACRO_ARROW      , ST_MACRO_EQ_ARROW , KC_NO                  , KC_NO     ,
   ST_MACRO_GRAVE , KC_1    , KC_2          , KC_3                  , KC_4              , KC_5        /* ,            , */              , ST_MACRO_15    , KC_NO    , KC_NO               , ST_MACRO_16       , ST_MACRO_PASTE_HISTORY , KC_NO     ,
   KC_TILD        , KC_EXLM , KC_AT         , KC_HASH               , KC_DLR            , KC_PERC /*     ,            , */              , KC_NO          , KC_NO    , KC_NO               , KC_NO             , ST_MACRO_SCLN_END      , KC_NO     ,
   KC_CAPS        , KC_NO   , KC_LPRN       , KC_RPRN               , KC_NO             , KC_NO          , KC_NO      , ST_MACRO_STRUCT , KC_NO          , KC_NO    , ST_MACRO_SHRINK_SEL , ST_MACRO_EXT_SEL  , ST_MACRO_VIM_SEARCH    , KC_RSHIFT ,
  ...
  [_FN] = LAYOUT(
   ...
   TO(_QWERTY) , KC_1  , KC_2  , KC_3     , KC_4  , KC_5        /*  ,         , */      , KC_6  , KC_7  , KC_8      , KC_9  , KC_0  , KC_BSPACE ,
   KC_F12      , KC_F1 , KC_F2 , KC_F3    , KC_F4 , KC_F5        /* ,         , */      , KC_F6 , KC_F7 , KC_F8     , KC_F9 , KC_F10 , KC_F11    ,
   KC_NO       , KC_NO , KC_NO , KC_NO    , KC_NO , KC_NO           , TO(_FN) , TO(_FN) , KC_NO , KC_NO , KC_NO     , KC_NO , KC_NO  , KC_NO     ,
  ...
  [_APP] = LAYOUT(
    ...
    LALT(LCTL(KC_PSCREEN))     , OSM(MOD_RGUI)               , LCTL(LGUI(KC_9))       , LALT(LCTL(LSFT(KC_C))) , LALT(LCTL(LSFT(KC_V))) , LALT(LCTL(LSFT(KC_B)))      , RCTL(KC_ESC)/*Windows_key*/ , OSM(MOD_RGUI) , LALT(LCTL(LSFT(KC_N))) , LCTL(LGUI(KC_6))       , LALT(KC_TAB)         , LALT(KC_GRAVE)                    , LCTL(LGUI(KC_0)) , KC_PSCREEN             ,
